...
<body class="index-page sidebar-collapse">
  ...
  <form method="post" action="user_payment.php">
    ...
    <h5>[ <small><?php echo $count2;?> </small>] Number of item.</h5>  
      ...
      <table class="table table-condensed table-bordered">
              <thead>
                <tr>
                  ...
                  <th width="100">Print on both sides</th>
                  <th width="100">NO of pages per sheet</th>
          ...
          ?>
              ...
              <tr>
                  ...
                  <td><br><?php  echo '<input type="checkbox" checked="checked" >'; ?></td>
                  <td><br><?php echo '<input class="cart-pages-input" type="number" value="1">';?></td>
                  <td>     
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <select class="btn btn-warning btn-round dropdown-toggle" size="1" name="shops">
                      <option value="Manila City">123</option>
                      <option value="Caloocan City">456</option>
